...
function getSuccessInfo($text='Default success message!', $zindex=1) {
    return <<<HTML
<style>
.success {
  position: fixed;
...
function getErrorInfo($text='Default error message!', $zindex=1) {
    return <<<HTML
...
<div id="error__card" class="error mt-3">
    ...
    <div id="error__title" class="error__title">$text</div>
